...
5. '*_NameKey.txt'
    ...
    5. This file will contain all generated files and their respective unqiue names generated from the 
       VGPA pipeline. Those files seen with a '#' are Ensembl files. 
...
7. '*_*.RAXML_output.phy"
	...
	7d."*_RAxML_bestTree.RAXML_output.phy" *REFER TO DOC '*_NameKey.txt' FOR NAMING OF SPECIES IN FILES*
	  ...
	  d. Will be generated last and takes the longest to geteate. This file can be viewed with a phylogenic tree veiwer. It contains a computer generated 	       
	     tree that is presumed to best fit species sequences into their respecive branch.
