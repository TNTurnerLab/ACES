...
6. <h4>'*_Phy_Align.phy' </h4> 
	...
	* Multi sequence file given from rule muscle and converted into a PHYLIP file format. Generated by [Rule muscle2](#RM2).
		...
		* '*_ Phy_Align.phy'is a multisequence alignment file that follows the formatting of PHYLIP files.
		  The file contains a unique id for all the sequences that are hits and found in the file 
		  named '*_ Multi_Seq_Align.fa'. This file is used as the input to rule [Rule RAXML](#RR), and can be 
