                        ...
                        #Parse out ID %
                            ...
                            if 'Gaps' in line:
                                ...
                                if float(sLength) >= float(qLength):
                                    ...
                                    match ='N'
                                print(match + str(qLength)+ '/' + str(sLength))
                    ...
                    with open(file, 'r') as fp:
                        ...
                        for line in fp:
                            ...
                            if 'YExpect' in line and '>' in line:
                                ...
                                if valueOnly in line:
                                    ...
                                    for var in Threshkey:
                                        ...
                                        if evalue > var:
                                            ...
                                            NoHitThresh.append(seqname + '-'+ fname)
                                            threshNOHitCnt +=1
                                            totalFileCount +=1
                                ...
                                #Increases count and stores filenames
                                NoHitThresh.append(seqname + str(qLength) + '/-' + fname)
                                threshNOHitCnt +=1
                                totalFileCount +=1
...
rule raxml: #Converts the Phylips file alignment to generate a RAXML phylogenic tree
    ...
    shell: """ /opt/conda/bin/raxmlHPC -b 1 -p 2 -# 2 -s {input[0]} -m PROTGAMMAWAG -n {params.prefix} """
rule cleanRAxML:
